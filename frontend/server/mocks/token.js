...
module.exports = function(app) {
  ...
  tokenRouter.post('/', function(req, res) {
    ...
    const payload = {
      'client_id': process.env.GITHUB_CLIENT_ID_DEVELOPMENT,
      'client_secret': process.env.GITHUB_CLIENT_SECRET_DEVELOPMENT,
    ...
    const options = {
      ...
      headers: {
        ...
        'User-Agent': process.env.GITHUB_USER_AGENT_DEVELOPMENT
      }
    };
